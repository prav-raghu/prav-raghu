...
## 🌍 Currently Building
- 🎓 **DRAMS** — Driver Rage Analytics & Mitigation System *(Proposed Master's thesis 1— Fast API, Python, TimescaleDB, PGVector, Redis, YOLOv8)*  (part of venta system private)
...
- 🟩 **vuqi-digital-signage** - GO + Vue JS (private)
- 🤖 **thola-ai-job-finder** - Python + SvelteKit (private)
...
## 📈 Activity Graph
[![Prav's Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=prav-raghu&theme=tokyo-night&hide_border=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
